...
```sh
curl -fsSL https://github.com/tui-tools/tui-cron/releases/download/v0.2.1/tui-cron_0.2.1_linux_amd64.tar.gz | tar -xz tui-cron
...
Website: https://tui.tools/tools/tui-cron/
<!-- install:end -->
